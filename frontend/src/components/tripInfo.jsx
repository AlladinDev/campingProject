...
export default function TripInfo() {
    ...
    presentDate = date.getFullYear()
    presentDate = presentDate + '-' + month
    presentDate = presentDate + '-' + date.getDate()
    console.log('today is', presentDate)
    console.log('present date as time string is', date.getTime(presentDate))
    console.log('2024-7-7 as time string is', date.getTime('2024-07-7'))
    console.log(new Date(presentDate) < new Date('2024-07-1'))
                    ...
                    <div className='w-full max-w-[480px] text-center bg-white shadow-gray-700 min-h-[50vh] p-4 shadow-lg rounded-sm'>
                        ...
                        <table className='w-full text-left mb-4'>
                            <tbody>
                                ...
                                <tr>
                                    <td className='text-2xl font-semibold'>Trip Date:</td>
                                    <td className='text-2xl'>{tripData.date}</td>
                                </tr>
                                <tr>
                        ...
                        {
                            new Date(presentDate) < new Date(tripData.date) ?
                                ...
                                :
                                <h2 className='p-3 bg-info'>Trip Already Started</h2>
                        }
